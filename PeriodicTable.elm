...
type alias PeriodicTable = List Element

periodicTable : PeriodicTable
periodicTable =
    decodeElements <| getElementList

getElementList : List (String, Json.Decode.Value)
getElementList = 
    case (Json.Decode.decodeString (Json.Decode.keyValuePairs (Json.Decode.value)) periodicTableString) of
        Result.Err err ->
            []
        Result.Ok elements ->
            elements
...
decodeElements elements =
    List.map decodeElement elements

decodeElement : (String, Json.Decode.Value) -> Element
decodeElement (name, data) =
    let
        constructing = Json.Decode.object2
        apply = Json.Decode.object2 (<|)
        atomic_mass = ("atomic_mass" := Json.Decode.float)
        symbol = ("symbol" := Json.Decode.string)
        number = ("number" := Json.Decode.int)
        aDecoder = (Json.Decode.object3 (Element name) atomic_mass number symbol)
    in
        case (Json.Decode.decodeValue aDecoder data) of
            Result.Err err ->
                Element "ERROR" 0.0 0 err
            Result.Ok element ->
                element


periodicTableString : String
periodicTableString =
    """{
  "Hydrogen": {
  ...
  "Fluorine": {
    ...
    "color": null,
    "density": 1.696,
    "discovered_by": "Andru00e9-Marie Ampu00e8re",
    "melt": 53.48,
    "molar_heat": null,
  ...
  "Sodium": {
    ...
    "summary": "Sodium /u02c8sou028adiu0259m/ is a chemical element with symbol Na (from Ancient Greek u039du03acu03c4u03c1u03b9u03bf) and atomic number 11. It is a soft, silver-white, highly reactive metal. In the Periodic table it is in column 1 (alkali metals), and shares with the other six elements in that column that it has a single electron in its outer shell, which it readily donates, creating a positively charged atom - a cation.",
    "symbol": "Na",
    "xpos": 1,
    "ypos": 3
  },
  ...
  "Silicon": {
    ...
    "color": null,
    "density": 2.329,
    "discovered_by": "Ju00f6ns Jacob Berzelius",
    "melt": 1687,
    "molar_heat": 19.789,
  ...
  "Vanadium": {
    ...
    "color": null,
    "density": 6.0,
    "discovered_by": "Andru00e9s Manuel del Ru00edo",
    "melt": 2183,
    "molar_heat": 24.89,
  ...
  "Gallium": {
    ...
    "spectral_img": null,
    "summary": "Gallium is a chemical element with symbol Ga and atomic number 31. Elemental gallium does not occur in free form in nature, but as the gallium(III) compounds that are in trace amounts in zinc ores and in bauxite. Gallium is a soft, silvery metal, and elemental gallium is a brittle solid at low temperatures, and melts at 29.76 u00b0C (85.57 u00b0F) (slightly above room temperature).",
    "symbol": "Ga",
    "xpos": 13,
    "ypos": 4
  },
  ...
  "Selenium": {
    ...
    "color": null,
    "density": 4.81,
    "discovered_by": "Ju00f6ns Jakob Berzelius",
    "melt": 494,
    "molar_heat": 25.363,
    "named_by": null,
    "number": 34,
  ...
  "Bromine": {
    ...
    "color": null,
    "density": 23.1028,
    "discovered_by": "Antoine Ju00e9ru00f4me Balard",
    "melt": 265.8,
    "molar_heat": null,
    "named_by": null,
    "number": 35,
  ...
  "Technetium": {
    ...
    "color": null,
    "density": 11,
    "discovered_by": "Emilio Segru00e8",
    "melt": 2430,
    "molar_heat": 24.27,
    "named_by": null,
    "number": 43,
    ...
    "spectral_img": null,
    "summary": "Technetium (/tu025bku02c8niu02d0u0283iu0259m/) is a chemical element with symbol Tc and atomic number 43. It is the element with the lowest atomic number in the periodic table that has no stable isotopes:every form of it is radioactive. Nearly all technetium is produced synthetically, and only minute amounts are found in nature.",
    "symbol": "Tc",
    "xpos": 7,
    "ypos": 5
  },
  ...
  "Tin": {
    "appearance": "silvery-white (beta, u03b2) or gray (alpha, u03b1)",
  ...
  "Tellurium": {
    ...
    "color": null,
    "density": 6.24,
    "discovered_by": "Franz-Joseph Mu00fcller von Reichenstein",
    "melt": 722.66,
    "molar_heat": 25.73,
    "named_by": null,
    "number": 52,
  ...
  "Cesium": {
    ...
    "spectral_img": null,
    "summary": "Caesium or cesium is a chemical element with symbol Cs and atomic number 55. It is a soft, silvery-gold alkali metal with a melting point of 28 u00b0C (82 u00b0F), which makes it one of only five elemental metals that are liquid at or near room temperature. Caesium is an alkali metal and has physical and chemical properties similar to those of rubidium and potassium.",
    "symbol": "Cs",
    "xpos": 1,
    "ypos": 6
  },
  ...
  "Europium": {
    ...
    "color": null,
    "density": 5.264,
    "discovered_by": "Eugu00e8ne-Anatole Demaru00e7ay",
    "melt": 1099,
    "molar_heat": 27.66,
    "named_by": null,
    "number": 63,
  ...
  "Mercury (element)": {
    ...
    "spectral_img": null,
    "summary": "Mercury is a chemical element with symbol Hg and atomic number 80. It is commonly known as quicksilver and was formerly named hydrargyrum (/hau026au02c8dru0251u02d0rdu0292u0259ru0259m/). A heavy, silvery d-block element, mercury is the only metallic element that is liquid at standard conditions for temperature and pressure; the only other element that is liquid under these conditions is bromine, though metals such as caesium, gallium, and rubidium melt just above room temperature.",
    "symbol": "Hg",
    "xpos": 12,
    "ypos": 6
  },
  ...
  "Lead": {
    ...
    "spectral_img": null,
    "summary": "Lead (/lu025bd/) is a chemical element in the carbon group with symbol Pb (from Latin:plumbum) and atomic number 82. Lead is a soft, malleable and heavy post-transition metal. Metallic lead has a bluish-white color after being freshly cut, but it soon tarnishes to a dull grayish color when exposed to air.",
    "symbol": "Pb",
    "xpos": 14,
    "ypos": 6
  },
  "Bismuth": {
    ...
    "color": null,
    "density": 9.78,
    "discovered_by": "Claude Franu00e7ois Geoffroy",
    "melt": 544.7,
    "molar_heat": 25.52,
    "named_by": null,
    "number": 83,
  ...
  "Thorium": {
    ...
    "spectral_img": null,
    "summary": "Thorium is a chemical element with symbol Th and atomic number 90. A radioactive actinide metal, thorium is one of only two significantly radioactive elements that still occur naturally in large quantities as a primordial element (the other being uranium). It was discovered in 1828 by the Norwegian Reverend and amateur mineralogist Morten Thrane Esmark and identified by the Swedish chemist Ju00f6ns Jakob Berzelius, who named it after Thor, the Norse god of thunder.",
    "symbol": "Th",
    "xpos": 4,
    "ypos": 10
  },
  ...
  "Bohrium": {
    ...
    "color": null,
    "density": 37.1,
    "discovered_by": "Gesellschaft fu00fcr Schwerionenforschung",
    "melt": null,
    "molar_heat": null,
    "named_by": null,
    "number": 107,
